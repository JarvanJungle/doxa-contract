pipeline {
    ...
    environment {
        ...
        DOCS_BUCKET = 'connex-docs/contract'
        DEV_REPO = 'doxa-connex-dev/contract'
        UAT_REPO = 'doxa-connex-uat/contract'
        UAT_USERID = '556257862131'
        STAG_REPO = 'doxa-connex-stag/contract'
        STAG_USERID = '538871320653'
        PROD_REPO = 'doxa-connex-prod/contract'
...
//          sh "/usr/local/bin/kubectl rollout status deployment/contract-deployment --namespace ${DEF_NAMESPACE}"
                }
            }
        }
